...
5.  **The Toolbelt (Crucial):** Look at the `system_boot` section and list the **Slash Commands** available (e.g., `/quiz`, `/summary`) with a brief description of what they do.
